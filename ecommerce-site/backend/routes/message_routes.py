...
from database.models import Message, Order, Product, PaymentMethod, AdminNotification, db
...
def send_payment_instructions():
    ...
    return success_response({'message': 'Payment instructions sent', 'order_id': order_id})
